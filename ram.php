<html>
    <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="../tasarim/ram2.css" />
        ...
        <body>
                <div class="orta">
                    ...
                    <?php 
                        ...
                        $sorgu=$baglan->prepare("SELECT baslik,yazi FROM pcbilgi WHERE kod='RAM'");
                        $sorgu->execute();
                    ...
                    <?php
                        foreach($amd as $bilgi) {?>
                            <h1><?= $bilgi->baslik ?></h1>
                            <img src="../görseller/ramm.png" style="height:250px;">
                            <h3> <?= $bilgi->yazi ?></h3>   
                    <?php }?>
                    </div>
                </div>
