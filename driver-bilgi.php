<html>
    <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="../tasarim/driver-giris.css" />
    ...
    <div class="üst">
        ...
        if($baslik==""||$yazi==""||$kod=="")
        {
            ...
            $ekle=$baglan->query(" INSERT INTO driver(kod,baslik,yazi) VALUES('$kod','$baslik','$yazi')",PDO::FETCH_ASSOC);
        }
        ?>
        <div class="kutu">
