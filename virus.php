<html>
    <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="../tasarim/virus2.css" />
    ...
    <div class="üst">
        ...
        <body>
                <div class="orta">
                    ...
                    <?php 
                        ...
                        $sorgu=$baglan->prepare("SELECT baslik,yazi FROM pchata WHERE kod='VIRUS'");
                        $sorgu->execute();
                    ...
                    <?php
                        foreach($amd as $bilgi) {?>
                            <h1><?= $bilgi->baslik ?></h1>
                            <img src="../görseller/virus.jpg" style="height:450px;">
                            <h3> <?= $bilgi->yazi ?></h3>   
                    <?php }?>
                    </div>
                </div>
        ...
        <div class="footer-content">
            <h3 class="konum2">the pc maps</h3>
            <p class="konum2">Bilgisayar ile ilgili her şey.</p>
            <ul class="socials">
