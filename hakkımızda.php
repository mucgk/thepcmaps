<html>
    <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="../tasarim/hakkımızda2.css" />
    ...
    <div class="üst">
        ...
        <div class="orta">
                        <div class="kutu">
                            <h1>Ben Kimim?</h1>
                            <h3>Ben Mücahit Ferhat Gökkaya, 21 yaşındayım ve yazılımla ilgim küçüklüğümden beri var. Küçüklükten beri yazılımcı olmak istemişimdir ve şuan bunu başarıyorum, mezun olabilirsem tabii. Umarım mezun olunca sadece bu site ile kalmam ve kendimi daha çok geliştirip, herkes için programlar, siteler geliştirebilirim. Küçüklükten gelen bir merak nerelere vesile oluyor, siz de ne merak ediyorsanız ne seviyorsanız onu yapmanız dileğiyle, sağlıcakla kalın.  </h3>
                        </div>  
               </div>
               <div class="alt">
               <footer>
