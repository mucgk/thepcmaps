<html>
    <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="../tasarim/power2.css" />
        ...
        <body>
                <div class="orta">
                    ...
                    <?php 
                        ...
                        $sorgu=$baglan->prepare("SELECT baslik,yazi FROM pcbilgi WHERE kod='POWER'");
                        $sorgu->execute();
                    ...
                    <?php
                        foreach($amd as $bilgi) {?>
                            <h1><?= $bilgi->baslik ?></h1>
                            <img src="../görseller/supply.png" style="height:250px;">
                            <h3> <?= $bilgi->yazi ?></h3>   
                    <?php }?>
                    </div>
                </div>
