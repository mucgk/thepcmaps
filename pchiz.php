<html>
    <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="../tasarim/pchiz.css" />
        ...
        <body>
               ...
               <div class="kutu">
                    <?php 
                        ...
                        $sorgu=$baglan->prepare("SELECT baslik,yazi FROM pchiz WHERE kod='HIZ'");
                        $sorgu->execute();
                    ...
                    <?php
                        foreach($amd as $bilgi) {?>
                            <h1><?= $bilgi->baslik ?></h1>
                            <img src="../görseller/hdd.png" style="height:250px;">
                            <img src="../görseller/ssd.png" style="height:250px;">
                            <h3> <?= $bilgi->yazi ?></h3>   
                            <img src="../görseller/hdd-ssd2.png" style="height:250px;">
                    <?php }?>
                    </div>
               </div>
               <div class="alt">
